...
var errorUnexpectedEndOfArray2 = create$1("Unexpected end of array");
var errorIntegerOutOfRange2 = create$1("Integer out of Range");
var Decoder = class {
  /**
  ...
  apply(provider, emitSynced) {
    ...
    switch (type) {
      ...
      case MessageType.CLOSE:
        const event = {
          code: 1e3,
          reason: readVarString2(message.decoder),
          // @ts-ignore
